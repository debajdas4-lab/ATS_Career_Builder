...
def _header(doc):
    ...
    # Break only between complete phrases so "Operational Efficiency" stays together.
    r = p.add_run("Transformation Leader | Enterprise Digital Transformation | Process Excellence | Business Operations |\nOperational Efficiency | Program Governance | SAP S/4HANA | Change Management | PMP")
